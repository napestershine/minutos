...
def edit_project(request, project_id):
    ...
    if request.method == 'POST':
        ...
        if title:
            ...
            messages.info(request, 'The project was edited!')
            return redirect('project:project', project_id=project_id)
...
def edit_task(request, project_id, task_id):
    ...
    if request.method == 'POST':
        ...
        if title:
            ...
            messages.info(request, 'The task was edited!')
            return redirect('project:task', project_id=project_id, task_id=task.id)
